	...
	return (
		<div>
			...
			>
				...
				>
					<Input
						placeholder={_l.TID_REGISTER_NAME_TIP}
						maxLength={81}
					/>
				</Form.Item>
				...
				<Form.Item
					...
					rules={[
						{
							required: true,
							message: _l.TID_REGISTER_PASSWORD_PLZ
						},
						{ max: 20, message: _l.TID_REGISTER_PASSWORD_OVER }
					]}
				>
					<Input.Password
						placeholder={_l.TID_REGISTER_PASSWORD_TIP}
						maxLength={21}
					/>
				</Form.Item>
				...
				<Form.Item
					...
					rules={[
						{
							required: true,
							message: _l.TID_REGISTER_PASSWORD_CONFIRM_PLZ
						},
						({ getFieldValue }) => ({
							validator(_, value) {
								if (
								...
								return Promise.reject(
									new Error(
										_l.TID_REGISTER_PASSWORD_CONFIRM_ERROR
									)
								)
							}
						})
				...
				>
					<Input.Password
						placeholder={_l.TID_REGISTER_PASSWORD_CONFIRM_TIP}
						maxLength={21}
					/>
				</Form.Item>
