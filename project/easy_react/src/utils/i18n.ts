...
const translations = {
    zh: {
        ...
        TID_MANAGE_USER_ADD_FAILED: "添加用户失败",
        TID_MANAGE_USER_EDIT_SUCCESS: "修改用户成功",
        TID_MANAGE_USER_EDIT_FAILED: "修改用户失败",
        ...
        TID_MANAGE_USER_INFO_REMOVE_CONFIRM: "确定删除该用户吗?",
    ...
    en: {
        ...
        TID_MANAGE_USER_INFO_REMOVE_CONFIRM: 'Are you sure to delete this user?',
    ...
    jp: {
        ...
        TID_MANAGE_USER_INFO_REMOVE_CONFIRM: 'ユーザーを削除してもよろしいですか？',
